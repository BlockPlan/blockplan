  ...
  return (
    <div className="page-bg">
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        {/* Contact Support */}
        <div className="mt-8 rounded-xl border border-blue-100 bg-blue-50/50 p-6 text-center shadow-[var(--shadow-card)]">
          ...
          <a
            ...
            className="mt-3 inline-flex items-center gap-2 rounded-lg bg-blue-600 px-5 py-2 text-sm font-medium text-white transition-colors hover:bg-blue-700"
          >
            Contact Support
          </a>
        ...
        {/* Footer */}
        <div className="mt-4 rounded-xl border border-gray-200 bg-white p-6 text-center shadow-[var(--shadow-card)]">
