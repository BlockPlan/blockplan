      ...
      <form action={formAction}>
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            name="notes"
            rows={6}
            className="w-full rounded-lg border border-gray-300 px-3 py-2 text-base text-gray-900 placeholder:text-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 sm:text-sm"
