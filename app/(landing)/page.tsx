        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="landing-fade-in landing-delay-3 mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <a
                href="#pricing"
                className="w-full rounded-xl border border-gray-200 bg-white px-8 py-3.5 text-base font-semibold text-gray-700 shadow-sm transition-all hover:border-gray-300 hover:bg-gray-50 sm:w-auto"
              >
                See Plans
              </a>
            </div>

            <p className="landing-fade-in landing-delay-3 mt-4 text-sm text-gray-500">
              Free forever. No credit card required.
            </p>
          </div>

          {/* Hero mockup area */}
          <div className="landing-fade-in landing-delay-4 mx-auto mt-16 max-w-4xl">
            <div className="relative rounded-2xl border border-gray-200 bg-gradient-to-b from-gray-50 to-white p-2 shadow-2xl shadow-gray-900/10">
              <div className="rounded-xl bg-white">
                {/* Simulated app screenshot / mockup */}
